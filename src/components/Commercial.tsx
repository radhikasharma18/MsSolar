  ...
  "
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-8">
          ...
          <div className="bg-gray-200/50 w-full md:w-1/2 p-6 md:p-8 flex flex-col gap-4 justify-between rounded-3xl group hover:bg-amber-600/70 transition duration-500">
            ...
            <div className="text-gray-600 text-lg md:text-xl group-hover:text-gray-100">
              Our experience engineering and installing high quality solar
              systems and our uncompromising service has made us a growing
              industry leader. Our professional installation teams have
              extensive experience and will build your system to our high
              standards.
            </div>
          ...
          <div className="bg-gray-200/50 w-full md:w-1/2 p-6 md:p-8 flex flex-col gap-4 justify-between rounded-3xl group hover:bg-amber-600/70 transition duration-500">
            ...
            <div className="text-gray-600 text-lg md:text-xl group-hover:text-gray-100">
              MSSolar is an all-in-one service provider. We will oversee your
              entire project with a single point of contact. Our in-house
              engineering team will custom design your solar system based on
      ...
      <section className="h-[70vh] md:p-16 p-6">
        ...
        >
          ...
          >
            <div className="text-2xl md:text-xl uppercase tracking-wide font-serif">
              Love with Nature
            </div>
        ...
        <div className="flex flex-col md:flex-row justify-around gap-6 md:gap-8">
          ...
          <div className="bg-gray-100 rounded-3xl p-6 md:p-8 flex flex-col gap-4 items-center md:w-1/3">
            <div className="text-center">
              ...
              <div className="text-lg md:text-xl">
                With solar you can secure predictable electricity costs for
                years to come
              </div>
            </div>
          ...
          <div className="bg-gray-100 rounded-3xl p-6 md:p-8 flex flex-col gap-4 items-center md:w-1/3">
            <div className="text-center">
              ...
              <div className="text-lg md:text-xl">
                Solar creates 91% less CO2 pollution than natural gas and 96%
                less CO2 than coal
              </div>
            </div>
          ...
          <div className="bg-gray-100 rounded-3xl p-6 md:p-8 flex flex-col gap-4 items-center md:w-1/3">
            <div className="text-center">
              ...
              <div className="text-lg md:text-xl">
                Clean solar energy provides us with an unlimited, reliable
                source of energy
              </div>
            </div>
            <div className="text-amber-600 font-bold flex justify-center mt-4">
      ...
      <section className="m-6 md:m-16 flex flex-col gap-8 md:gap-12">
        ...
        <div className="text-center md:text-left">
          <div className="text-amber-600 text-xl md:text-2xl font-semibold">
            TESTIMONIALS
          </div>
        ...
        >
          ...
          <div className="absolute flex flex-col gap-6 px-4 text-center md:px-16">
            <div className="text-2xl md:text-4xl lg:text-5xl font-semibold">
              Get a pricing quote for a commercial or industrial panel
              installation
            </div>
