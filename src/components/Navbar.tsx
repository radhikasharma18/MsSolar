          ...
          <div className="flex items-center gap-8">
            ...
            <div className="lg:flex gap-6 text-lg hidden">
              ...
              <button
                ...
                className={`font-manrope transition-colors ${
                  isActive("/residential")
                    ? "text-white underline decoration-amber-600 font-bold text-2xl cursor-pointer"
              ...
              <button
                ...
                className={`font-manrope transition-colors ${
                  isActive("/aboutus")
                    ? "text-white underline decoration-amber-600 font-bold text-2xl currsor-pointer"
                    : "hover:text-amber-600 cursor-pointer"
                }`}
              >
                About us
